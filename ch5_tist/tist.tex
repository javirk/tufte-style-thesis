...
\subsubsection{Publication}This chapter is based on a publication\sideauthorcite{ghamsarian2023domain}, and its contents have been modified slightly to be more consistent with the rest of the thesis. 

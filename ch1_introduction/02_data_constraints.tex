...
Translation of a point by $t_x$ and $t_y$ units along the x and y-axis respectively:
\begin{equation*}
    \renewcommand*{\arraystretch}{0.8}
    \begin{pmatrix} 1 & 0 & t_x \\ 0 & 1 & t_y \\ 0 & 0 & 1 \end{pmatrix}.
\end{equation*}
}, rotation\sidenote{
Rotation of an angle $\theta$ about the origin:
\begin{equation*}
    \renewcommand*{\arraystretch}{0.8}
    \begin{pmatrix} \cos\theta & -\sin\theta & 0 \\ \sin\theta & \cos\theta & 0 \\  0 & 0 & 1 \end{pmatrix}.
\end{equation*}
}, scaling\sidenote{
Scaling of $W$ and $H$ units about the origin:
\begin{equation*}
    \renewcommand*{\arraystretch}{0.8}
...
\subsection{Domain Adaptation, or How to Expand to Unseen Data}\index{Domain adaptation}

...
\sidechaptersummary{How Limitations lead to New Ideas, Test-time Prediction and its Connection to Human Thinking, Reinforcement Learning in Computer Vision}
\desctotoc{How Limitations lead to New Ideas --- Test-time Prediction and its Connection to Human Thinking --- Reinforcement Learning in Computer Vision}

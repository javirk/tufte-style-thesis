\graphicspath{{ch3_fullweak/}{Figures/}}
...
\sidechaptersummary{Optimal budget allocation for image labeling, Future segmentation performance prediction, Gaussian Processes as surrogate models}
\desctotoc{Optimal budget allocation for image labeling --- Future segmentation performance prediction --- Gaussian Processes as surrogate models}
